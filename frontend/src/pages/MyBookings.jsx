                    ...
                    {loading ? (
                        ...
                        <div className="divide-y divide-gray-100">
                            {bookings.map((booking) => {
                                ...
                                const canCancel = statusConfig.canCancel && booking.status === 'PENDING';
                                            ...
                                            <div className="flex flex-row lg:flex-col gap-2 lg:items-end">
                                                ...
                                                {canCancel && (
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 px-4 py-2 bg-white border border-rose-200 rounded-xl text-sm font-semibold text-rose-600 hover:bg-rose-50 hover:border-rose-300 transition-all"
                                                    >
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                            <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-rose-50 to-white">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-text-primary">Cancel Booking</h3>
                            ...
                            <div className="p-6 border-t border-gray-100 flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={processing}
                                    className="flex-1 px-4 py-2.5 bg-rose-600 text-white rounded-xl text-sm font-semibold hover:bg-rose-700 transition disabled:opacity-50"
                                >
                                    {processing ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : 'Yes, Cancel Booking'}
                                </button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-amber-600">
                                                Editing your booking will not change the time slot. Your request will remain pending and will need to be approved again by an admin.
                                            </p>
                                        </div>
                                    </div>
                                </div>
